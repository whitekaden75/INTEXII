...
// Import the user context from your auth logic
...
const MovieDetail = () => {
  ...
  const handleRateMovie = async () => {
    const payload = {
      userId: user ? 1 /* replace with actual user id from context if available */ : 1,
      showId: movie.showId,
      rating: userRating,
    };
  ...
  // Create a safe title for the poster URL
          ...
          {!user ? (
            ...
            <>
                ...
                <div className="md:col-span-8 flex flex-col gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <h2 className="text-lg font-semibold mb-1">Average Rating</h2>
              ...
              {!loadingRecommendations && recommendations.length > 0 && (
                <div className="mt-4">
                  <RecommendedMovies title="Movies Like This" movies={recommendations} />
                </div>
              )}
